...
public class BestTimeBuyAndSellStock {
    ...
    /**
     * 题目的意思是说：假设您有一个数组，其中第 i 个元素是第 i 天给定股票的价格。如果你只被允许完成至多一笔交易（即买一份，卖一份股票），设计一个算法来找到最大利润。
     *
     * 请注意，在购买股票之前，您不能出售股票。
     *
     * 算法分析：
     *
     * 根据题目的意思分析出两点：（1）在购买股票之前，不能出售股票，即需要先买后买；（2）只被允许完成至多一笔交易（即买一份，卖一份股票），那么第i天的价格可以看作是买入价也可以看作是卖出价。
     *
     * 算法设计
     *
